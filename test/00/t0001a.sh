...
assert "\$data(2,1)==7" "d(2,1) sum"
assert "\$data(2,2)==9" "d(2,2) sum"
assert "\$data(1,3)==7" "d(2,1) sum"
...
assert "\$data(2,1)==.5" "d(2,1) stddev"
...
assert "\$data(1,2)==7" "d(1,2) swapped"
...
dc.populateArray data
assert "\$data(1,1)==10" "d(1,1) x summed"
assert "\$data(2,1)==14" "d(2,1) x summed"
assert "\$data(3,1)==18" "d(2,1) x summed"
...
dc.populateArray data
assert "\$data(1,1)==64" "d(1,1) y summed"

# expand x handle
dc.ravel.handles(0).moveTo [expr 5*[dc.ravel.handles(0).x]] [expr 5*[dc.ravel.handles(0).y]] 0
assert {![dc.ravel.handles(0).collapsed]} {}
dc.populateArray data
assert "\$data(1,1)==24" "d(1,1) x summed"
assert "\$data(1,2)==40" "d(1,2) x summed"
